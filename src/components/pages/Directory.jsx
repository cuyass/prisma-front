    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Directori de Recursos</h1>
      ...
      <div className="bg-gradient-to-r from-purple-100 to-blue-100 py-12 px-4 mt-16">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-bold mb-4">Coneixeu algun recurs que hauria d'estar aquí?</h2>
          <p className="text-gray-600 max-w-xl mx-auto mb-6">
            Ajudeu-nos a millorar aquest directori recomanant recursos LGBTQ+ i de ciberseguretat que considereu valuosos per a la comunitat.
          </p>
